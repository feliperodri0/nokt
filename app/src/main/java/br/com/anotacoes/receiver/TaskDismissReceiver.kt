...
class TaskDismissReceiver : BroadcastReceiver() {
    ...
    @Inject
    lateinit var handler: TaskDismissHandler
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        val extras = mapOf(
            TaskDismissHandler.EXTRA_TASK_ID to intent.getStringExtra(TaskDismissHandler.EXTRA_TASK_ID)
        )
